...
<form:form action="${pageContext.request.contextPath}/register"
    ...
    <br>
    <input type="text"
           placeholder="<spring:message code="local.account.name" />" name="name"/>
    <br>
    <br>
    <input type="email" placeholder="<spring:message code="local.account.email" />" name="email"/>
    <br>
    <br>
    <input type="password" placeholder="<spring:message code="local.password" />" name="pass"/>
    <br>
    <br>
    <input type="submit" value="<spring:message code="local.button.submit"/>  "/>
</form:form>
</body>
</html>